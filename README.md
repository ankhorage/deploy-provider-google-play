...
# @ankhorage/deploy-provider-google-play
...
Google Play deployment provider for Ankhorage application shipment.
...
- [createGooglePlayDeploymentProvider sequence](././paradox/diagrams/sequences/create-google-play-deployment-provider.mmd)
